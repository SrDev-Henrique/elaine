        ...
        <div className="flex w-full flex-col gap-6">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p itemProp="description">
                Com mais de 2 anos de experiência, eu combino técnica, presença
                e sensibilidade para criar sessões personalizadas que convidam à
                presença, ao autoconhecimento corporal e ao despertar das
                sensações.
              </p>
              <p itemProp="description">
